    ...
    $(document).ready(function(){
        ...
        $('#addsform').on('submit',function (e){
            ...
            $.ajax({
                ...
                type:'POST',
                url: '<?php echo e(route('adds.store')); ?>',
                data:data,
                cache: false,
                contentType: false,
                processData: false,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\graphic-town\resources\views/admin/Adds/index.blade.php ENDPATH**/ ?>