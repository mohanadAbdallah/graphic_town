    ...
    <div class="content-header">
        ...
        <section class="content">
            ...
            <div class="modal " id="createCategory" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <form id="addform" class="needs-validation" enctype="multipart/form-data" method="post" action="<?php echo e(route('categories.store')); ?>" novalidate>
                            <?php echo csrf_field(); ?>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#DeleteCategory').on('click','.delete_category_btn',function (e){
            ...
            $.ajax({
                type:"delete",
                url: "<?php echo e(url('admin/categories')); ?>/"+category_id,
                dataType: 'json',
                beforeSend:function (){
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\graphic-town\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>